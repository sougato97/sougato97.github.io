...
comments:
  ...
  body: >
    This page supports GitHub-based comments. LinkedIn does not offer a native
    embedded comments widget for a page like this, so LinkedIn discussion would
    need to happen through a separate post.
  note: >
    If the widget does not load the first time, install the app for this
    repository once, and GitHub users will be able to comment directly here.
  app_href: https://github.com/apps/utterances
  app_label: Open the Utterances GitHub app
